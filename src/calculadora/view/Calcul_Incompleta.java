 ...
 * @author Feh
 */
public class Calcul_Incompleta extends javax.swing.JFrame {

    /**
     * Creates new form Calculadora_Bhaskara
     */
    public Calcul_Incompleta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanelLilas.setBackground(new java.awt.Color(204, 255, 204));
        ...
        lblTituloLilas.setText("EQUAÇÃO COMPLETA DO SEGUNDO GRAU INCOMPLETA ");
        ...
        lblInstrução.setText("Encontrar os zeros (raízes) da equação ax² + bx = 0");
        ...
        jPanelLilas1.setBackground(new java.awt.Color(204, 255, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calcul_Incompleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
